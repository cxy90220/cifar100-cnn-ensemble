...
def CNN_model(n,epoch):
    ...
    model.fit(train_data, train_label, epochs=epoch, batch_size=500)
    filename = 'ensemble/' + 'ensemble' + str(epoch) + '_' + str(n+6) + '.h5'
    model.save(filename)
